...
class BuildExe:
    def __init__(self):
        ...
        self.license = "GPL Version 3"
 
        #Auhor of program
        self.author_name = "RedSoxFan/Kareemroks101"
        self.author_email = ""
        self.copyright = "Copyright (c) 2015"
 
        #Description
        self.project_description = "Ludum Dare 34 Entry"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['saxmono.ttf']
 
        #Extra/excludes python modules
        self.extra_modules = ["input", "messages", "particles", "platform",
                              "player", "screens", "tile", "utils", "world", "pygame.font"]
